<section id="js-why" class="cd-section">
	<div class="content-wrapper content-wrapper__padding">
		...
		<p class='text__block'>
			IMLS is your chance to build your network and learn from other leaders. Our programs are based around emerging industry topics and we use attendee feedback to optimize every event. Additionally, as an invite-only event, there are no vendors, only marketers. Our goal is to make sure you’re getting the most out of your time with us.
		</p>
